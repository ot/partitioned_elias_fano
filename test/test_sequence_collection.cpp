...
void test_sequence_collection()
{
    ...
    typedef quasi_succinct::sequence_collection<BaseSequence>
        collection_type;
...
{
    test_sequence_collection<quasi_succinct::indexed_sequence>();
    test_sequence_collection<quasi_succinct::partitioned_sequence<>>();
    test_sequence_collection<quasi_succinct::uniform_partitioned_sequence<>>();
}
