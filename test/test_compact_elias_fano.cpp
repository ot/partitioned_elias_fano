...
struct sequence_initialization {
    sequence_initialization()
    {
        ...
        quasi_succinct::compact_elias_fano::write(bvb,
                                                  seq.begin(),
                                                  universe, seq.size(),
                                                  params);
                        ...
                        sequence_initialization)
{
    ...
    test_sequence(quasi_succinct::compact_elias_fano(), params, 1, short_seq);
    short_seq[0] = 1;
    test_sequence(quasi_succinct::compact_elias_fano(), params, 2, short_seq);
}
                        ...
                        sequence_initialization)
{
    ...
    quasi_succinct::compact_elias_fano::offsets of(0,
                                                   universe, seq.size(),
                                                   params);
    uint64_t rank = 0;
...
BOOST_FIXTURE_TEST_CASE(compact_elias_fano_enumerator,
                        sequence_initialization)
{
    quasi_succinct::compact_elias_fano::enumerator r(bv, 0,
                                                     universe, seq.size(),
                                                     params);
    test_sequence(r, seq);
}
                        ...
                        sequence_initialization)
{
    ...
    test_sequence(quasi_succinct::compact_elias_fano(), params, universe, seq);
}
